var EntropyCollector = function (global) {
    ...
    return {
        ...
        set eventTarget(e) {
            stop(), _event_target = e
        },
        get eventsCaptured() {
            return min(_event_counter, _buffer_size)
        },
...
function seedToWordList(seed) {
    ...
    var first = SHA256(words.join(" ")).slice(0, 10);
